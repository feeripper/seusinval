      ...
      <SidebarHeader className="gap-0 px-5 pt-6 pb-5">
        <button type="button" onClick={() => go('Governança')} className="flex items-center gap-3 rounded-xl text-left transition-colors hover:bg-n-50" aria-label="Ir para Governança de dados e IA">
          ...
          <div className="min-w-0">
            <div className="text-[15px] leading-tight font-semibold tracking-tight text-n-900">Seu Sinval</div>
            <div className="text-[11.5px] leading-tight text-n-500">governança de dados e IA</div>
          </div>
        </button>
      </SidebarHeader>
      ...
      <SidebarContent className="gap-1 px-3">
        <SidebarGroup className="p-0">
          ...
          <SidebarMenu className="gap-0.5">
            <NavButton active={view === 'Governança'} onClick={() => go('Governança')} icon={LayoutDashboard} label="Visão geral" />
          </SidebarMenu>
        </SidebarGroup>
